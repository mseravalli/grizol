...
cargo watch -x "run -- --config /home/marco/workspace/mydama/tests/config.textproto --certs /home/marco/downloads/cert.pem --key /home/marco/downloads/key.pem --port 23456 --require-auth=false --proto 'bep/1.0' 2>&1 | tee /tmp/grizol_log"
